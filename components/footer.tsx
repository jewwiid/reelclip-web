...
export async function Footer() {
  ...
  return <footer className="border-t border-hairline px-6 py-12 sm:px-10"><div className="mx-auto grid max-w-6xl gap-8 sm:grid-cols-[1fr_auto] sm:items-start"><div className="flex flex-col gap-6"><div className="relative h-9 w-32 shrink-0"><Image src="/wordmark.png" alt="ReelClip" fill sizes="8rem" className="object-contain object-left" /></div><p className="max-w-md text-sm leading-relaxed text-text-muted">{footer.description}</p><p className="text-[11px] font-bold uppercase tracking-[0.22em] text-accent">{footer.tagline}</p></div><div className="grid grid-cols-2 gap-x-10 gap-y-6 text-sm sm:grid-cols-4"><FooterCol title={footer.product}><Link href={href("/#modes")} className="hover:text-text transition-colors">{footer.modes}</Link><Link href={href("/#safety")} className="hover:text-text transition-colors">{footer.why}</Link><Link href={href("/#ai-notes")} className="hover:text-text transition-colors">{footer.howAI}</Link><Link href={href("/#for")} className="hover:text-text transition-colors">{footer.creators}</Link><Link href={href("/competitors")} className="hover:text-text transition-colors">{footer.compare}</Link><Link href={href("/pricing")} className="hover:text-text transition-colors">{footer.pricing}</Link><Link href={href("/blog")} className="hover:text-text transition-colors">{footer.blog}</Link></FooterCol><FooterCol title={footer.account}><Link href={href("/account")} className="hover:text-text transition-colors">{footer.manage}</Link><a href="https://apps.apple.com/account/subscriptions" target="_blank" rel="noreferrer" className="hover:text-text transition-colors">{footer.appStoreSubscription}</a><a href="https://apps.apple.com/app/reelclip/id6787742864" target="_blank" rel="noreferrer" data-event-name="download_click_footer" className="hover:text-text transition-colors">{footer.download}</a></FooterCol><FooterCol title={footer.legal}><Link href={href("/brand")} className="hover:text-text transition-colors">{footer.brandAssets}</Link><Link href={href("/privacy")} className="hover:text-text transition-colors">{footer.privacy}</Link><Link href={href("/terms")} className="hover:text-text transition-colors">{footer.terms}</Link><Link href={href("/support")} className="hover:text-text transition-colors">{footer.support}</Link><Link href={href("/about")} className="hover:text-text transition-colors">{footer.about}</Link></FooterCol><FooterCol title={footer.follow}><a href="https://www.instagram.com/reelclipapp/" target="_blank" rel="noreferrer" className="inline-flex w-fit items-center gap-2 transition-colors hover:text-text"><InstagramIcon />Instagram <span aria-hidden="true">↗</span></a><a href="https://www.tiktok.com/@reelclipapp" target="_blank" rel="noreferrer" className="inline-flex w-fit items-center gap-2 transition-colors hover:text-text"><TikTokIcon />TikTok <span aria-hidden="true">↗</span></a><span className="text-text-faint">@reelclipapp</span></FooterCol></div></div><div className="mx-auto mt-10 flex max-w-6xl flex-col items-center justify-between gap-3 border-t border-hairline pt-6 text-xs text-text-faint sm:flex-row"><div>© {new Date().getFullYear()} ReelClip. {footer.rights}</div><div>{footer.devicePromise}</div></div></footer>;
}
